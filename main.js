...
`;
    ...
    let leftMenuArray = [
      { icon: "fa-solid fa-house", text: "Home", img: "" },
      { icon: "fa-solid fa-magnifying-glass ", text: "Search", img: "" },
      { icon: "fa-regular fa-compass", text: "Explore", img: "" },
      { icon: "fa-brands fa-google-play", text: "Reels", img: "" },
      { icon: "fa-brands fa-telegram ", text: "Messages", img: "" },
      { icon: "fa-regular fa-heart", text: "Notifications", img: "" },
      { icon: "fa-regular fa-square-plus", text: "Create", img: "" },
      { icon: "fa-solid fa-store", text: "MarketPlace", img: "" },
      {
        icon: "",
        text: "Profile",
    ...
    function leftMenuCreator() {
      leftMenuArray.forEach((element) => {
        ...
        <div class="d-flex align-items-start img-leftMenu-container">
           <img
            class="img-fluid rounded-5 border-bla"
            src="${element.img}"
           />
